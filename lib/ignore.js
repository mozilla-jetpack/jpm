...
/**
 * look for .jpmignore in the giving directory and use it to filter files and sub-directories
...
/**
 * chekc if a giving file or dir should be kept
 *
 * @param {String}  p
 * @param {Array}   rules
 * @param {String}  root
